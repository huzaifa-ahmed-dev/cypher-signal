  ...
  return (
    <>
      ...
      <span className="absolute right-full mr-4 bg-white text-[#0A192F] font-bold text-sm px-4 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl border border-gray-100 pointer-events-none origin-right">
        ...
        <span className="absolute top-1/2 -right-1.5 -translate-y-1/2 border-y-4 border-y-transparent border-l-[6px] border-l-white"></span>
      </span>
      ...
      <a
        ...
        className="relative bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.5)] hover:bg-[#20bd5a] hover:scale-110 hover:shadow-[0_6px_25px_rgba(37,211,102,0.7)] transition-all duration-300 flex items-center justify-center z-10"
      ...
      >
        ...
        {/* Real WhatsApp Icon */}
        <svg viewBox="0 0 24 24" fill="currentColor" width="32" height="32" className="relative z-10">
