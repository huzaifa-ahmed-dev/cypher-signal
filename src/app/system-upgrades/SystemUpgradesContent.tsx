...
export default function SystemUpgradesContent() {
  const features = [
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            <div className="relative w-full max-w-lg aspect-[4/3] lg:aspect-square flex items-center justify-center p-6">
               ...
               >
                 <ArrowUpCircle className="w-8 h-8 text-[#00E676]" />
               </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400 text-base md:text-lg mb-10 max-w-lg leading-relaxed">
              <strong className="text-white">Leave nothing to chance.</strong> Upgrade your legacy analog infrastructure to cutting-edge IP camera networks with zero downtime and full continuity.
            </p>
            
            <a 
              href="#contact-upgrade" 
