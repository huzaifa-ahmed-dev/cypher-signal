      ...
      <section className="relative pt-12 pb-20 md:pt-24 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
          ...
          >
            ...
            <span className="text-[#00E676] font-semibold">Premium CCTV Solutions</span>
          </motion.div>
          ...
          >
            Fortify Your Perimeter with <span className="text-gradient">Smart CCTV Installation</span>
          </motion.h1>
          ...
          >
            Complete camera system setups for homes, offices, and warehouses across the UAE with absolutely zero blind spots.
          </motion.p>
          ...
          >
            <a href="#contact-cctv" className="bg-[#00E676] text-[#0A192F] px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#00c968] transition-all shadow-[0_0_20px_rgba(0,230,118,0.4)] hover:shadow-[0_0_30px_rgba(0,230,118,0.6)]">
